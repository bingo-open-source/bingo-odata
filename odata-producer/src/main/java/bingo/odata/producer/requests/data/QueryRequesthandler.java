...
public class QueryRequesthandler extends ODataRequestHandlerBase{
    ...
    protected void doHandle(ODataProducerContext context, ODataRequest request, ODataResponse response) throws Throwable {
		...
		ODataContent content = context.getProducer().query(context, queryInfo);
		
		write(context, request, response, content);
    }
}
