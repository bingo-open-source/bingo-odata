...
public class EdmDataServices {
    ...
    public EdmEntitySet getEdmEntitySet(final EdmEntityType type) {
        ...
        EdmEntitySet ees = IterableEnumerable.of(getEntitySets()).firstOrNull(new Predicate<EdmEntitySet>() {
    ...
    public Iterable<EdmStructuralType> getStructuralTypes() {
        return IterableEnumerable.of(getEntityTypes()).cast(EdmStructuralType.class).concat(IterableEnumerable.of(getComplexTypes()).cast(EdmStructuralType.class));
    }
    ...
    public Iterable<EdmStructuralType> getSubTypes(EdmStructuralType t) {
        return IterableEnumerable.of(getStructuralTypes()).where(OPredicates.edmSubTypeOf(t));
    }
