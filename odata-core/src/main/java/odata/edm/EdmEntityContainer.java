...
public class EdmEntityContainer extends EdmItem {
    ...
    private EdmEntityContainer(String name, boolean isDefault, Boolean lazyLoadingEnabled, ImmutableList<EdmEntitySet> entitySets, ImmutableList<EdmAssociationSet> associationSets,
    ...
    public static class Builder extends EdmItem.Builder<EdmEntityContainer, Builder> {
        ...
        Builder newBuilder(EdmEntityContainer entityContainer, BuilderContext context) {
            ...
            return new Builder()
                    .setName(entityContainer.name)
                        .setIsDefault(entityContainer.isDefault)
                        .setLazyLoadingEnabled(entityContainer.lazyLoadingEnabled)
                        .addEntitySets(entitySets)
                        .addAssociationSets(associationSets)
                        .addFunctionImports(functionImports);
        }
