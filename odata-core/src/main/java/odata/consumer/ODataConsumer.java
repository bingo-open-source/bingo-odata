...
import odata.EntitySetInfo;
import odata.OCreateRequest;
import odata.OEntity;
import odata.OEntityGetRequest;
import odata.OEntityId;
import odata.OEntityKey;
import odata.OEntityRequest;
import odata.OFunctionRequest;
import odata.OModifyRequest;
import odata.OObject;
import odata.OQueryRequest;
import odata.ORelatedEntitiesLink;
import odata.ORelatedEntityLink;
import odata.consumer.behaviors.OClientBehavior;
...
public interface ODataConsumer {
     ...
     */
    List<EntitySetInfo> getEntitySets();
