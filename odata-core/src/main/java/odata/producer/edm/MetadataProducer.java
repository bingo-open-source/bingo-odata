...
import odata.OCollection.Builder;
...
import odata.format.xml.EdmxFormatWriter;
...
import odata.producer.ExpressionEvaluator;
import odata.producer.ODataProducer;
import odata.producer.PropertyPath;
import odata.producer.PropertyPathHelper;
import odata.producer.QueryInfo;
import odata.producer.Responses;
import odata.producer.ExpressionEvaluator.VariableResolver;
    ...
    private OEntity getStructuralType(Context c, EdmStructuralType st) {
        ...
        if (c.pathHelper.isSelected(Edm.StructuralType.NavProps.SubTypes)) {
            if (c.pathHelper.isExpanded(Edm.StructuralType.NavProps.SubTypes)) {
                List<EdmStructuralType> stypes = EnumerableImpl.of(dataProducer.getMetadata().getSubTypes(st)).toList();
