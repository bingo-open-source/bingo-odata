...
import odata.format.json.JsonStreamReaderFactory.JsonParseException;
import odata.format.json.JsonStreamReaderFactory.JsonStreamReader;
import odata.format.json.JsonStreamReaderFactory.JsonStreamTokenizer;
import odata.format.json.JsonStreamReaderFactory.JsonStreamReader.JsonEndPropertyEvent;
import odata.format.json.JsonStreamReaderFactory.JsonStreamReader.JsonEvent;
import odata.format.json.JsonStreamReaderFactory.JsonStreamReader.JsonStartPropertyEvent;
import odata.format.json.JsonStreamReaderFactory.JsonStreamReader.JsonValueEvent;
import odata.format.json.JsonStreamReaderFactory.JsonStreamTokenizer.JsonToken;
import odata.format.json.JsonStreamReaderFactory.JsonStreamTokenizer.JsonTokenType;
...
public class JsonStreamReaderFactory {
    ...
    public interface JsonStreamTokenizer {
        ...
        public enum JsonTokenType {
            LEFT_CURLY_BRACKET, RIGHT_CURLY_BRACKET, LEFT_BRACKET, RIGHT_BRACKET, COMMA, COLON, TRUE, FALSE, NULL, NUMBER, STRING;
        }
