...
public class ODataForbiddenException extends ODataError {

	private static final long serialVersionUID = -8816614230856627697L;

	public ODataForbiddenException(String message) {
		super(SC_FORBIDDEN, EC_FORBIDDEN, message);
	}

	public ODataForbiddenException(String message, Throwable cause) {
		super(SC_FORBIDDEN, EC_FORBIDDEN, message, cause);
	}
}