...
public class EdmFunctionImport extends EdmItem {
    ...
    private EdmFunctionImport(String name, EdmEntitySet entitySet, EdmType returnType, String httpMethod, ImmutableList<EdmFunctionParameter> parameters, EdmDocumentation doc,
    ...
    public static class Builder extends EdmItem.Builder<EdmFunctionImport, Builder> {
        ...
        Builder newBuilder(EdmFunctionImport functionImport, BuilderContext context) {
            ...
            return new Builder().setName(functionImport.name).setEntitySet(functionImport.entitySet != null ? EdmEntitySet.newBuilder(functionImport.entitySet, context) : null).setReturnType(
                    functionImport.returnType).setHttpMethod(functionImport.httpMethod).addParameters(functionParameters);
        }
        ...
        public EdmFunctionImport build() {
            ...
            EdmType returnType = this.returnType != null ? this.returnType : returnTypeBuilder != null ? returnTypeBuilder.build() : null;
            return new EdmFunctionImport(name, entitySet == null ? null : entitySet.build(), returnType, httpMethod, ImmutableList.copyOf(parameters), getDocumentation(), ImmutableList
                    .copyOf(getAnnotations()));
        }
