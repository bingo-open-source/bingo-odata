...
public class EdmSchema extends EdmItem {
    ...
    private EdmSchema(String namespace, String alias, ImmutableList<EdmEntityType> entityTypes, ImmutableList<EdmComplexType> complexTypes, ImmutableList<EdmAssociation> associations,
            ImmutableList<EdmEntityContainer> entityContainers, EdmDocumentation doc, ImmutableList<EdmAnnotation<?>> annots) {
        super(doc, annots);
    ...
    public static class Builder extends EdmItem.Builder<EdmSchema, Builder> {
        ...
        Builder newBuilder(EdmSchema schema, BuilderContext context) {
            ...
            return new Builder().setNamespace(schema.namespace).setAlias(schema.alias).addEntityTypes(entityTypes).addComplexTypes(complexTypes).addAssociations(associations).addEntityContainers(
                    entityContainers);
