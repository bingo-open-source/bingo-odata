...
public class EdmProperty extends EdmPropertyBase {
    ...
    public enum CollectionKind {
        ...
        Collection
        // used in FunctionImport return types and parameter types
    }
    ...
    private EdmProperty(EdmDocumentation documentation, ImmutableList<EdmAnnotation<?>> annotations, String name, EdmStructuralType declaringType, EdmType type, boolean nullable, Integer maxLength,
            Boolean unicode, Boolean fixedLength, String storeGeneratedPattern, String fcTargetPath, String fcContentKind, String fcKeepInContent, String fcEpmContentKind, String fcEpmKeepInContent,
