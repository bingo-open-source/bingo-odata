...
public class EdmComplexType extends EdmStructuralType {
    ...
    private EdmComplexType(String namespace, String name, List<EdmProperty.Builder> properties, EdmDocumentation documentation, ImmutableList<EdmAnnotation<?>> annots, Boolean isAbstract) {
