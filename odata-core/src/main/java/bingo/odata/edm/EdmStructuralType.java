...
public abstract class EdmStructuralType extends EdmNonSimpleType implements Named {
    ...
    protected EdmStructuralType(EdmEntityType baseType, String namespace, String name, List<EdmProperty.Builder> declaredProperties, EdmDocumentation doc, ImmutableList<EdmAnnotation<?>> annotations,
            Boolean isAbstract) {
     ...
     */
    public List<EdmProperty> getDeclaredProperties() {
        return CollectionUtils.newList(declaredProperties);
    }
    ...
    public List<EdmProperty> getProperties() {
        return isRootType() ? getDeclaredProperties() : Collections.concat(baseType.getProperties(), getDeclaredProperties());
    }
