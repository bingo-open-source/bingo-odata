package bingo.odata.producer.edm;
...
import bingo.odata.edm.EdmDecorator;
import bingo.odata.edm.EdmEntityContainer;
import bingo.odata.edm.EdmEntitySet;
import bingo.odata.edm.EdmEntityType;
import bingo.odata.edm.EdmGenerator;
...
import bingo.odata.edm.EdmProperty.CollectionKind;
import bingo.odata.format.xml.XmlFormatParser;
...
public class MetadataEdmGenerator implements EdmGenerator {
    ...
    public EdmDataServices.Builder generateEdm(EdmDecorator decorator) {
        ...
        container = EdmEntityContainer.newBuilder().setName(Edm.ContainerName).setIsDefault(true).setLazyLoadingEnabled(Boolean.TRUE).addEntitySets(esets).addAssociationSets(asets);

        schema = EdmSchema.newBuilder().setNamespace(Edm.namespace).addEntityTypes(etypes).addComplexTypes(ctypes).addAssociations(assocs).addEntityContainers(container);
    ...
    private void createComplexTypes() {
        ...
        EdmComplexType.Builder propertyRef = EdmComplexType.newBuilder().setNamespace(Edm.namespace).setName(XmlFormatParser.EDM2008_9_PROPERTYREF.getLocalPart()).addProperties(props);
    ...
    private void createEntityTypes() {
        ...
        EdmEntityType.Builder schemaType = EdmEntityType.newBuilder().setNamespace(Edm.namespace).setName(Edm.Schema.name()).addKeys(keys).addProperties(props).addNavigationProperties(navprops);
        if (decorator != null) {
        ...
        EdmEntityType.Builder structuralType = EdmEntityType.newBuilder().setNamespace(Edm.namespace).setName(Edm.StructuralType.name()).addKeys(keys).addProperties(props).addNavigationProperties(
                navprops);
        if (decorator != null) {
        ...
        EdmEntityType.Builder complexType = EdmEntityType
                .newBuilder()
        ...
        EdmEntityType.Builder propertyType = EdmEntityType.newBuilder().setNamespace(Edm.namespace).setName(Edm.Property.name()).addKeys(keys).addProperties(props).addNavigationProperties(navprops);
        if (decorator != null) {
        ...
        EdmAssociation.Builder assoc = defineAssociation(Edm.Schema.NavProps.EntityTypes, EdmMultiplicity.ONE, EdmMultiplicity.MANY, schemaType, schemaSet, structuralType, entitySet);
        ...
        assoc = defineAssociation(Edm.Schema.NavProps.ComplexTypes, EdmMultiplicity.ONE, EdmMultiplicity.MANY, schemaType, schemaSet, complexType, complexSet);
        ...
        assoc = defineAssociation(Edm.EntityType.NavProps.Properties, EdmMultiplicity.ONE, EdmMultiplicity.MANY, structuralType, entitySet, propertyType, propertySet);
        ...
        assoc = defineAssociation(Edm.EntityType.NavProps.SubTypes, EdmMultiplicity.ONE, EdmMultiplicity.MANY, structuralType, entitySet, structuralType, entitySet);
        ...
        assoc = defineAssociation(Edm.EntityType.NavProps.SuperType, EdmMultiplicity.ONE, EdmMultiplicity.ZERO_TO_ONE, structuralType, entitySet, structuralType, entitySet);
    ...
    private EdmAssociation.Builder defineAssociation(String assocName, EdmMultiplicity fromMult, EdmMultiplicity toMult, EdmEntityType.Builder fromEntityType, EdmEntitySet.Builder fromEntitySet,
        ...
        EdmAssociationSet.Builder associationSet = EdmAssociationSet.newBuilder().setName(assocName).setAssociation(association).setEnds(
