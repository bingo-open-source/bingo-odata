...
import bingo.odata.producer.resources.ODataBatchProvider.HTTP_METHOD;
...
public class BatchBodyPart {
    ...
    public String getEntitySetName() {
        ...
        return i != -1 ? this.uriLast.substring(0, i) : this.uriLast;
    }

    public String getEntityKey() {
        int i = this.uriLast.indexOf('(');
        return i > -1 && i < this.uriLast.length() ? this.uriLast.substring(i) : null;
    }
