...
import bingo.odata.producer.ODataProducerFactory;
...
public class DefaultODataProducerProvider implements ContextResolver<ODataProducer> {
    ...
    private void initializeInstance() {
        ...
        if (instance == null)
            throw new RuntimeException("Unable to find an OData producer implementation. Call ODataProducerProvider.setInstance to set the static singleton or set the producer factory property \'"
                    + FACTORY_PROPNAME + "\' in either the system properties or a container-specifc manner to a class name that implements ODataProducerFactory.");
    }
