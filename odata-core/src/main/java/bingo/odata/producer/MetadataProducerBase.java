...
public abstract class MetadataProducerBase implements MetadataProducer {

	public EdmEntitySet findEntitySet(String entitySetName) {
		return getServicesMetadata().findEntitySet(entitySetName);
	}

	public EdmFunctionImport findFunctionImport(String functionName) {
	    return getServicesMetadata().findFunctionImport(functionName);
    }
