 ...
 */
package bingo.odata.server.requests.data.delete;
...
public class DeleteEntityRequestHandler extends ODataRequestHandlerBase {

	@Override
	protected void doHandle(ODataRequestContext context, ODataRequest request, ODataResponse response) throws Throwable {
		// TODO implement DeleteEntityRequestHandler.doHandle
