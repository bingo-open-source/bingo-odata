...
public class TypeConverterTest {
    ...
    public void testTemporalTypes() throws ParseException {
        ...
        Assert.assertEquals(new java.sql.Timestamp(dateTimeParser.parse("03/28/2011 7:20:21 pm").getTime()), TypeConverter.convert(
                new LocalDateTime(2011, 03, 28, 19, 20, 21),
