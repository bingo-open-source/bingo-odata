package bingo.odata.test.unit.producer;
...
public class PropertyPathHelperTest {
    ...
    public void testMulti() {
        ...
        for (int i = 1; i < 100; i++) {
            ...
            assertTrue((i == 1 && h.isExpanded("Properties")) || (i > 1 && !h.isExpanded("Properties")));
            assertFalse(h.isExpanded("NotExpandedNavProp"));
    ...
    public void testRecursive() {
        PropertyPathHelperTester h = new PropertyPathHelperTester("Name,Alias", // $select
                    "EntityTypes",
    ...
    public void testRecursiveOverride() {
        PropertyPathHelper h = new PropertyPathHelper("Name,Alias,EntityTypes/SubTypes/Prop1", // $select
                    "EntityTypes", // $expand
                    "SubTypes/Namespace,SubTypes/Name", // $selectR
                    "SubTypes/0,Properties/1");
