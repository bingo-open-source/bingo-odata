package odata.test.unit.expressions;
...
import odata.expression.AggregateAllFunction;
import odata.expression.AggregateAnyFunction;
import odata.expression.AndExpression;
import odata.expression.BinaryLiteral;
import odata.expression.BooleanLiteral;
import odata.expression.CastExpression;
import odata.expression.CeilingMethodCallExpression;
import odata.expression.CommonExpression;
import odata.expression.ConcatMethodCallExpression;
import odata.expression.DateTimeLiteral;
import odata.expression.DateTimeOffsetLiteral;
import odata.expression.DayMethodCallExpression;
import odata.expression.DecimalLiteral;
import odata.expression.DivExpression;
import odata.expression.DoubleLiteral;
import odata.expression.EndsWithMethodCallExpression;
...
import odata.expression.FloorMethodCallExpression;
import odata.expression.GeExpression;
import odata.expression.GtExpression;
import odata.expression.GuidLiteral;
import odata.expression.HourMethodCallExpression;
import odata.expression.IndexOfMethodCallExpression;
import odata.expression.Int64Literal;
import odata.expression.IntegralLiteral;
import odata.expression.IsofExpression;
import odata.expression.LeExpression;
import odata.expression.LengthMethodCallExpression;
import odata.expression.LtExpression;
import odata.expression.MinuteMethodCallExpression;
import odata.expression.ModExpression;
import odata.expression.MonthMethodCallExpression;
import odata.expression.MulExpression;
import odata.expression.NeExpression;
import odata.expression.NegateExpression;
import odata.expression.NotExpression;
import odata.expression.NullLiteral;
import odata.expression.OrExpression;
import odata.expression.OrderByExpression;
import odata.expression.ParenExpression;
import odata.expression.ReplaceMethodCallExpression;
import odata.expression.RoundMethodCallExpression;
import odata.expression.SecondMethodCallExpression;
import odata.expression.SingleLiteral;
import odata.expression.StartsWithMethodCallExpression;
import odata.expression.StringLiteral;
import odata.expression.SubExpression;
import odata.expression.SubstringMethodCallExpression;
import odata.expression.SubstringOfMethodCallExpression;
import odata.expression.TimeLiteral;
import odata.expression.ToLowerMethodCallExpression;
import odata.expression.ToUpperMethodCallExpression;
import odata.expression.TrimMethodCallExpression;
import odata.expression.YearMethodCallExpression;
...
public class ExpressionTest {
    ...
    public void testAnyNestedPredicate() {
        t(Expression.any(Expression.simpleProperty("Actors"), "a", Expression.any(Expression.simpleProperty("a/Awards"), "w", Expression.eq(Expression.simpleProperty("w/Name"), Expression
                .string("Oscar")))), "Actors/any(a:a/Awards/any(w:w/Name eq 'Oscar'))");
    }
    ...
    public void testAllNestedPredicate() {
        // now that is a cast..
        t(Expression.all(Expression.simpleProperty("Actors"), "a", Expression.all(Expression.simpleProperty("a/Awards"), "w", Expression.eq(Expression.simpleProperty("w/Name"), Expression
                .string("Oscar")))), "Actors/all(a:a/Awards/all(w:w/Name eq 'Oscar'))");
    }

    @Test
    public void testAnyAllNestedPredicate() {
        t(Expression.any(Expression.simpleProperty("Actors"), "a", Expression.all(Expression.simpleProperty("a/Awards"), "w", Expression.eq(Expression.simpleProperty("w/Name"), Expression
                .string("Oscar")))), "Actors/any(a:a/Awards/all(w:w/Name eq 'Oscar'))");
    }

    @Test
    public void testAnyAllNestedPredicate2() {
        t(
                Expression.any(Expression.simpleProperty("Actors"), "a", Expression.or(Expression.all(Expression.simpleProperty("a/Awards"), "w", Expression.eq(
                        Expression.simpleProperty("w/Name"),
                            Expression.string("Oscar"))), Expression.any(Expression.simpleProperty("a/Houses"), "h", Expression.eq(Expression.simpleProperty("h/City"), Expression.string("Malibu"))))),
