...
public class AtomEntryFormatParserTest extends AbstractEntryFormatParserTest {
    ...
    private StringReader buildAtom(String property) {
        return new StringReader("" + "<entry" + " xmlns=\"http://www.w3.org/2005/Atom\"" + " xmlns:m=\"http://schemas.microsoft.com/ado/2007/08/dataservices/metadata\""
                + " xmlns:d=\"http://schemas.microsoft.com/ado/2007/08/dataservices\">" + "<content type=\"application/xml\">" + "<m:properties>" + property + "</m:properties>" + "</content>"
                + "</entry>");
    }
}
